    ...
    <div class="span12">
      <div class="w-box">
        ...
        <div class="w-box-content table-responsive">
          <a href="<?=base_url();?>index.php/masterdata/Peserta_didik/tambah_peserta_didik?idskolah=<?php echo $row->id_skolah?>"><center><input type="button" class="btn-link" name="" value="Tambah Pesera Didik"></center></a>
