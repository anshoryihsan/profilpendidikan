  ...
  <div class="row-fluid blog_page">
    <div class="span2 pull-right">
      <div class="blog_content pull-left" id="n_combobox">
        <form class="" action="<?php echo base_url('index.php/kepaladinas/home'); ?>" method="post">
    ...
    <div class="span11">
      <form class="" action="<?php echo base_url('index.php/kepaladinas/cetak/cetakPDF'); ?>" method="post">
      <?php foreach ($kbb as $row): ?>
