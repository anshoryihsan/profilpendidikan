...
<div class="container">
  <ul id="breadcrumbs">
    ...
    <!--<li><//?php foreach ($isi as $row): endforeach;?><a href="<?=base_url();?>index.php/upt/profil/profilsekolah?idnss=<//?php echo $row->nss; ?>">Profil Sekolah</i></a></li>-->
  ...
  <div class="">
    <nav class="nav-icons">
      <ul>
        ...
        <li><?php foreach ($isi as $row): endforeach;?><a href="<?=base_url();?>index.php/upt/Peserta_didik/detailpesertadidik?idnss=<?php echo $row->id_skolah; ?>" class="ptip_s" title="Peserta Didik">Peserta Didik</a></li>
...
<div class="container">
  <div class="row-fluid">
    <div class="span12">
      <div class="w-box">
        <div class="w-box-header">
          <h4>Data Pendidik dan Tenaga Kependidikan</h4>
        </div>
        <div class="w-box-content table-responsive">
          <a href="<?=base_url();?>index.php/upt/PTK/tambah?idskolah=<?php echo $row->id_skolah?>"><center><input type="button" class="btn-link" name="" value="Tambah PTK"></center></a>
          <table  id="form" class="table table-striped table-bordered nowrap" cellspacing="0" width="100%">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <div class="span3">
                    <a href="<?=base_url();?>index.php/upt/ptk/ubah?idptk=<?php echo $row->id_ptk; ?>">
                      <input type="button" name="" value="Ubah">
                    </a>
                  </div>
                  <div class="span3">
                    <a href="<?=base_url();?>index.php/upt/ptk/delete?idptk=<?php echo $row->id_ptk;?>&idpeserta2=<?php echo $row->id_skolah; ?>" onclick="return confirm ('Anda akan menghapus data <?php echo $row->nama;?> ?')">
